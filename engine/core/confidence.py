"""Log-odds confidence model: additive, auditable, per-signal.

Unlike a linear weighting (which used status to compute confidence and
...
# Seeded values; recalibrate from engagement history as evidence accumulates.
...
# State thresholds: score alone cannot jump the validation gate.
