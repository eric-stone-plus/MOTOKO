...
Requires TWO distinct canaries to conclude a negative: one empty poll is
not proof — the canary server or the target egress may have blinked. A
single positive callback is sufficient to confirm.
