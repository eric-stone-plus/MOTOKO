...
Implements the round mechanism: reward score, convergence predicate, degradation
...
def reward(prev: dict | None, curr: dict, findings: list[dict]) -> float:
    """Compute the round reward score R_t."""
