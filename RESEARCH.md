...
- Source: an internal review held in the private monorepo at
  `engine/docs/reviews/`, condensed and redacted for this public tree. The
  review itself was read-only: it changed no files and cloned nothing.
